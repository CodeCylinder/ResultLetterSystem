...
class TCPDF {
	 ...
	 * @public
	 */
	public function setFooterMargin($fm=1) {
	...
	public function Footer() {
		...
		// } else {
			...
			// $this->Cell(0, 10,'*This is a system generated document & does not carry a signature*',$this->getAliasRightShift().$pagenumtxt, 'T', 0, 'R');
		// }
		//Position at 24 mm from top. if from bottom use -24
		$this->SetY(24);
		//Set font
		$this->SetFont('helvetica', 'I', 9);
		//Page number
		$this->Cell(0, 10, '*This is a system generated document & does not carry a signature*                      '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
	}
