<?php
		...
		{		
			$output.='<h4 align="right">'.date("Y-m-d").'</h4>
					...
					<p align="justify">This is to certify that <b>Ms./Mr. ' .$row["InitName"].'</b> has appeared for the Final Examination conducted by the Department of Technical Education & Training
						in<b> December '.$row["ExamYear"].'</b> under the<b> Index No ' .$row["IndexNo"].'</b> having followed the <b>One-Year, Full Time, '.$row["CourseName"].'</b> in <b>'.$row["ExamMedium"].'
 ...
 {  
      ...
      $obj_pdf->SetTitle("Final Exam-One Year");  
	  ...
	  $obj_pdf->Output('finaloneyear.pdf', 'I');
 }
...
<h3 align="center" style="color:#C65353"><p>Generate  Final Statement of Result</p><p>for One-Year Courses</p></h3>
<br></div>
<div id="divform1" >
