<?php
	function fetch_data()
	{
		...
		if (isset($_POST['regno']) AND isset($_POST['semes']) AND isset($_POST['year']) AND isset($_POST['acyr1']) AND isset($_POST['acyr2'])){
		$semes =$_POST['semes'];
		$year =$_POST['year'];
		$regno =$_POST['regno'];
		$acyr1 =$_POST['acyr1'];
		$acyr2 =$_POST['acyr2'];
		$query="SELECT * FROM tblexamresult WHERE RegNo='$regno' AND Semester='$semes' AND ExamYear='$year'";
 ...
 {  
      ...
      $obj_pdf->SetTitle("Semester 01 Two-Year");  
	  ...
	  $obj_pdf->Output('sem1twoyear.pdf', 'I');
 }
...
<h3 align="center" style="color:#C65353"><p>Generate Statement of Result</p><p>for Year 01 in Two-Year Courses</p></h3>
<br></div>
<div id="divform1" >
	<form  class="form1" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
			<label>Reg.No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" name="regno" placeholder="Type Index.." ><br><br>
