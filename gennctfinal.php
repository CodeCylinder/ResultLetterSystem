<?php
	...
	function fetch_data()
	{
		...
		$result=mysqli_query($con,$query) or die(mysqli_error($con));
			...
			$output.='
					<tr>
						<td rowspan="12" width="12%" align="center">'.$year1.'</td>
						<td rowspan="12" width="14%" align="center">Semester 01</td>
						<td width="40%">'.$row["Subject1"].'</td>
						<td width="17%">'.$row["Result1"].'</td>
						<td rowspan="12" width="17%" align="center">'.$row["FinalResult"].'</td>
					</tr>
					<tr>
						<td >'.$row["Subject2"].'</td>
						<td >'.$row["Result2"].'</td>
			...
			$output.='
					<tr>
						<td rowspan="12" width="12%" align="center">'.$year2.'</td>
						<td rowspan="12" width="14%" align="center">Semester 02</td>
						<td width="40%">'.$row["Subject1"].'</td>
						<td width="17%">'.$row["Result1"].'</td>
						<td rowspan="12" width="17%" align="center">'.$row["FinalResult"].'</td>
					</tr>
					...
					';}
				if (($row["IndexNo"]="$inre") && ($row["Semester"]="Semester 3") && ($row["ExamYear"]='$year3')){
			$output.='
					<tr>
						<td rowspan="12" width="12%" align="center">'.$year3.'</td>
						<td rowspan="12" width="14%" align="center">Semester 03</td>
						<td width="40%">'.$row["Subject1"].'</td>
						<td width="17%">'.$row["Result1"].'</td>
						<td rowspan="12" width="17%" align="center">'.$row["FinalResult"].'</td>
					</tr>
...
if(isset($_POST["create_pdf"]))  
 {  
      ...
      $obj_pdf->SetTitle("NCT - Result Sheet");  
      ...
      $obj_pdf->AddPage();  
      $content = '';  
      $content .= '<h5 align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>To Whom it may Concern</u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.date("Y-m-d").'</h5>
		<h5>Course :'.$coname.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Medium :'.$row['ExamMedium'].'</h5>
		<h5>Name : '.$row['FullName'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Index No :'.$inre.'</h5>	  
      <table border="1" cellspacing="0" cellpadding="1">
	  <tr>
		<th align="center" width="12%"><b>Year</b></th>
		<th align="center" width="14%"><b>Semester</b></th>
		<th align="center" width="40%"><b>Subject</b></th>
		<th align="center" width="17%"><b>Result</b></th>
		<th align="center" width="17%"><b>Final Result</b></th>
	</tr>';  
      $content .= fetch_data();  
      $content .= '</table>';	  
      $obj_pdf->writeHTML($content);
      $obj_pdf->Output('allsemesters.pdf', 'I');
 }
...
<!DOCTYPE HTML>
<html>
<head> <title>Result Sheet-NCT-Final-PDF</title>
<style type="text/css">
.form1{
...
<h3 align="center" style="color:#C65353"><p>Generate Sheet Result </p><p>for all Semesters in NCT Course</p></h3>
<br></div>
<div id="divform1" align="justify">
	<form  class="form1" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
			...
			<label>Semester 03 Exam Year</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="year3" placeholder="Type Year.." ><br><br>
					<?php
